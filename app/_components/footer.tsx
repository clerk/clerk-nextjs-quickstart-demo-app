    ...
    <footer className='min-[2500px]::max-w-[50rem] flex w-full flex-col flex-wrap items-start border-t border-[#EEEEF0] bg-white pt-6 pr-6 pb-9 pl-6 md:flex-row md:flex-nowrap md:justify-between xl:mx-auto'>
      <div className='mr-auto ml-auto flex justify-start md:w-2/3'>
        <a
          ...
          target='_blank'
          className='flex items-center gap-2 px-3 py-2 text-[0.8125rem] font-medium'
        >
          <svg
            width='16'
            height='16'
        ...
        <ul className='flex flex-row flex-wrap justify-between'>
          <li>
            <a
              href='https://clerk.com/docs?utm_source=nextjs-app-quickstart&utm_medium=template_repos&utm_campaign=nextjs_keyless_quickstart'
              target='_blank'
          ...
          <li>
            <a
              href='https://github.com/clerk/clerk-nextjs-quickstart-demo-app'
              target='_blank'
              className='flex items-center gap-2 rounded-full px-3 py-2 text-[0.8125rem] font-medium hover:bg-gray-100'
            >
              <svg
